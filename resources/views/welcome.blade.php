	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav m-auto">
			  ...
			  <li class="nav-item"><a href="http://www.cartaosaudeprevencao.com.br/public/form_sind.html" class="nav-link">Sindicato</a></li>
	          ...
	          <li class="nav-item"><a href="http://www.cartaosaudeprevencao.com.br/login" target="_blank" class="nav-link">Acesso painel</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
