    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-xs-12 col-sm-7 col-md-7">
                <form method="POST" action="#" id="formIdTarget" accept-charset="UTF-8" class="form-horizontal"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <input class="field-form" type="text" autocomplete="off" name="users[name]" id="name"
                                placeholder="* Nome do contato" required="required" />
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                            <input class="field-form" type="text" autocomplete="off" name="users[document]"
                                id="document" placeholder="* CPF" required="required" />
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                            <input class="field-form" type="text" autocomplete="off" name="enderecos[telefone1]"
                                id="telefone" placeholder="* Telefone (Ex: 11 999999999)" required="required" />
                        </div>

                        <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                            <input class="field-form" type="email" autocomplete="off" name="users[email]" id="email"
                                placeholder="* E-mail" required="required" />
                        </div>

                        <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                            <input class="field-form" type="text" autocomplete="off" name="empresas[name]" id="empresa"
                                placeholder="Nome da empresa (NÃO É OBRIGATÓRIO)" />
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                            <input class="field-form" type="text" autocomplete="off" name="empresas[cnpj]" id="cnpj"
                                placeholder="CNPJ da empresa (NÃO É OBRIGATÓRIO)" />
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <input class="field-form" type="number" autocomplete="off"
                                        name="planosSaude[qtd_vidas]" id="qtd_vidas" placeholder="* Quantidade de vidas"
                                        required="required" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <input class="field-form" type="text" autocomplete="off" onblur="findCep()"
                                        name="endereco[zipCode]" id="endereco_zipCode" placeholder="* CEP" />
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                                    <input class="field-form" type="text" autocomplete="off" maxlength="2"
                                        name="endereco[state]" id="endereco_state" placeholder="* Estado" />
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                                    <input class="field-form" type="text" autocomplete="off" name="endereco[city]"
                                        id="endereco_city" placeholder="* Cidade" />
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                                    <input class="field-form" type="text" autocomplete="off"
                                        name="endereco[neighborhood]" id="endereco_neighborhood" placeholder="* Bairro" />
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                                    <input class="field-form" type="text" autocomplete="off" name="endereco[street]"
                                        id="endereco_street" placeholder="* Rua" />
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                                    <input class="field-form" type="text" autocomplete="off" name="endereco[number]"
                                        id="endereco_number" placeholder="* Número" />
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">
                                    <input class="field-form" type="text" autocomplete="off" name="endereco[complement]"
                                        id="endereco_complement" placeholder=" Complemento (NÃO É OBRIGATÓRIO)" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accordion" id="accordionExample">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-12 col-md-12"
                                                            ...
                                                            <input class="field-form" type="text" autocomplete="off"
                                                                name="cartao_credito[number]" id="cartao_credito_number"
                                                                placeholder="* Número do cartão" />
                                                        </div>
                                                        <div class="col-xs-12 col-sm-12 col-md-12"
                                                            style="margin-top: 20px;">
                                                            <input class="field-form" type="text" autocomplete="off"
                                                                name="cartao_credito[holder]" id="cartao_credito_holder"
                                                                placeholder="* Nome no cartão" />
                                                        </div>
                                                        <div class="col-xs-12 col-sm-12 col-md-12"
                                                            style="margin-top: 20px;">
                                                            <input class="field-form" type="text" autocomplete="off"
                                                                name="cartao_credito[expiresAt]"
                                                                id="cartao_credito_expiresAt"
                                                                placeholder="* Validade do cartão (Mês e Ano)"
                                                                required="required" />
                                                        </div>
                                                        <div class="col-xs-12 col-sm-12 col-md-12"
                                                            style="margin-top: 20px;">
                                                            <div class="row">
                                                                <div class="col-xs-12 col-sm-9 col-md-9">
                                                                    <input class="field-form" type="text"
                                                                        autocomplete="off" name="cartao_credito[cvv]"
                                                                        id="cartao_credito_cvv"
                                                                        placeholder="* Código de segurança do cartão"
                                                                        required="required" />
                                                                </div>
                                                                <div class="col-xs-12 col-sm-3 col-md-3 botao-enviar">
                                                                    <input type="button" name="btn-enviar"
                                                                        class="btn btn-enviar" id="btn-enviar" value=">" />
                                                                    <span class="text-primary aguarde_text">Por favor
                                                                        aguarde.</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                        data-parent="#accordionExample">
                                        <div class="card-body">
                                            <input type="button" name="btn-enviar-boleto"
                                                class="btn btn-success btn-enviar-boleto" id="btn-enviar-boleto"
                                                value="Gerar boleto" />
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 explanation">
                ...
                <p>Preencha o formulário ao lado e nossos corretores parceiros entrarão em contato com você em horário
                    comercial.</p>
                ...
                success: function(response) {
                    if (response == 'chave_igual') {
                        ...
                        Swal.fire({
                            ...
                            text: `O cadastro foi efetuado com sucesso e está sobre analise da nossa equipe de vendas, você receberá um email de confirmação. \n Número do protocolo: ${response.Subscription.Customer.myId}.`,
                            onAfterClose: () => {
                                window.location.href = response.Subscription.Transactions[0]
                                    .Boleto.pdf;
                            }
                        });
                    }
